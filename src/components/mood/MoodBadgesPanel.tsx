              ...
              <Tooltip key={b.code}>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <div className="text-xs text-muted-foreground leading-tight line-clamp-2">{b.description}</div>
                    {unlocked ? (
                  ...
                  <div className="space-y-1.5">
                    ...
                    {unlocked ? (
                      ...
                      <div className="space-y-1">
                        <p className="text-xs font-medium">{t("moodComp.badges.howToUnlock")}</p>
