  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-sm font-bold text-foreground">Analyse IA complétée</h3>
      </div>

      <p className="text-base text-muted-foreground leading-relaxed mb-4">
        Selon ton style et ta destination, ton budget optimal est estimé à{" "}
        <span className="text-2xl font-extrabold gradient-text">{totalBudget}€</span>{" "}
        pour <span className="font-bold text-foreground">{days} jours</span> à{" "}
