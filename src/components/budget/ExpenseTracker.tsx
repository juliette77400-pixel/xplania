...
const ExpenseTracker = ({ categories }: Props) => {
  return (
    ...
    >
      <h2 className="text-lg font-bold text-foreground mb-1">Tableau de Suivi des Dépenses</h2>
      <p className="text-sm text-muted-foreground mb-6">Suivi en temps réel de tes dépenses par catégorie</p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-right py-3 px-2 text-muted-foreground font-medium">Prévu</th>
              <th className="text-right py-3 px-2 text-muted-foreground font-medium">Dépensé</th>
              <th className="text-right py-3 px-2 text-muted-foreground font-medium">Reste</th>
              <th className="text-center py-3 px-2 text-muted-foreground font-medium">Statut</th>
            </tr>
          </thead>
          <tbody>
                ...
                >
                  <td className="py-3 px-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-foreground">{cat.key}</span>
                    </div>
                  </td>
      ...
      {/* Répartition bar */}
      <div className="mt-6">
        <h3 className="text-sm font-semibold text-foreground mb-3">Répartition</h3>
