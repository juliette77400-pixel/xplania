    ...
    <DialogContent className="max-w-2xl overflow-hidden border-border bg-background p-0 sm:rounded-3xl" aria-describedby="onboarding-description">
      ...
      <div className="grid min-h-[430px] sm:grid-cols-[.8fr_1.2fr]">
        ...
        <main className="flex flex-col p-6 sm:p-9">
          <button onClick={close} className="ml-auto flex min-h-[40px] items-center rounded-lg px-3 py-2 text-sm font-medium text-muted-foreground transition hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">{t("common.skip")}</button>
