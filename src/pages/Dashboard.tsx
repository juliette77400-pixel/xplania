    ...
    <main className="container mx-auto max-w-6xl space-y-10 px-4 py-7 sm:py-12">
      <motion.header initial={{opacity:0,y:-10}} animate={{opacity:1,y:0}} className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button asChild variant="outline" className="h-11 rounded-xl px-4 font-semibold" title="Revoir ton profil voyageur (mode consultation, aucun score n'est modifié)"><Link to="/"><Heart className="mr-2 h-4 w-4 text-primary" />Revoir mon Tinder</Link></Button>
